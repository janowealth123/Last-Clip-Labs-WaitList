          ...
          <div className="space-y-6">
            ...
            <div className="pt-4 pb-8">
              <button
                ...
                className="glow-button relative inline-flex items-center gap-2 bg-white text-indigo-700 px-8 py-4 rounded-full font-medium 
        ...
        <div className="py-12 grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="glow-button w-full bg-white text-indigo-700 font-medium py-3 px-6 rounded-xl flex items-center justify-center gap-2 
